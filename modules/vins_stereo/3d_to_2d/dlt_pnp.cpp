...
namespace vins {
    ...
    bool Estimator::dltpnp(const std::shared_ptr<Frame> &frame_i, unsigned int batch_size, unsigned int num_batches) {
        constexpr static unsigned long th_count = 6;    ///< DLTPnP至少需要6个点
