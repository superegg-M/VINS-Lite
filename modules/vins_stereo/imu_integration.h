...
namespace vins {
    ...
    public:
        ...
        void set_acc_init(const Vec3 &acc) { _acc_init = acc; }
        void set_gyro_init(const Vec3 &gyro) { _gyro_init = gyro; }
        void set_acc_last(const Vec3 &acc) { _acc_last = acc; }
        void set_gyro_last(const Vec3 &gyro) { _gyro_last = gyro; }
